...
spitest.test_args.update({TEST_ARGS_NAME : f"perf_spi_launch_pipe/perf_spi_launch_pipe_ipw{inst_ipw}_tg{grid_size_x}_wpg{workgroup_size_x}_pip{pip}"})
