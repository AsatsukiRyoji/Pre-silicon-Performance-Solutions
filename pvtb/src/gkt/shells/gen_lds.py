...
lds_test_ptn = 'perf_lds_(\w+)_ipw(\d+)_wpg(\d+)'
...
inst_arg_str, all_args = LdsClass.get_args_from_name(lds_test_ptn, INST_ARGS_INST, INST_ARGS_IPW, INST_ARGS_WPG)
