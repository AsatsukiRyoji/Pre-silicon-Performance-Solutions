...
from cpdc_aql_dispatch import *
cpdc_test_ptn = "perf_cp_dc_aql_dispatch_dpq1_dimx(\d+)_dimy(\d+)_dimz(\d+)_tpgx(\d+)_wpg(\d+)"
inst_arg_str, all_args = CpDc.get_args_from_name(cpdc_test_ptn,
