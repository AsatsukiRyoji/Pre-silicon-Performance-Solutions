...
# -*- coding: utf-8 -*-
"""
Global load (To VGPR) Performance Model
@author: Ma Xingxing
"""
import os,sys,re
...
class GlobalLoadPM(PerfTestPM):
    
    def __init__(self):
        super(GlobalLoadPM, self).__init__()
        self.test_cfg = testpm_cfg_d['global_load']
